...
const TransactionsOut = (props: any, { fallback }: any) => {
  ...
  let url = `http://localhost:5007/api/transactions/list?type=2&row=${states.data.dataPerPage}&page=${states.data.currentPage}&key=${states.filter.key}&column=${states.filter.columns}&direction=${states.filter.directions}`
    ...
    <>
      <SWRConfig value={{ fallback }}>
        ...
        <Card
          ...
          title="List of Outgoing Transactions"
          extra={
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const getList: any = await axios.get(`http://localhost:5007/api/transactions/list?type=2&key=${params.key}&page=${params.page}&row=${params.row}&column=${params.column}&direction=${params.direction}`, {
    headers: {
...
TransactionsOut.getLayout = function getLayout(page: ReactElement) {
