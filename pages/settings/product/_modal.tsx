...
import { modalState } from "../../../interfaces/product.interface"
      ...
      <Row>
        <Col span={24}>
          <Form layout="vertical">
            ...
            <Row>
              <Col span={24}>
              <Form.Item label="Category" name="category_id" initialValue={states.form.category_id}>
                            <Select
                                value={states.form.category_id}
                                onChange={handleChangeSelect}
                                options={states.master?.categories}
